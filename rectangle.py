...
class Rectangle:
    ...
    def expansion_area_cost(self, rect: 'Rectangle'):
        ...
        temp_width, temp_height, temp_area = temp_rect.calculate_properties()
    ...
    def __str__(self):
        print("LLx: " + str(self.lower_left.x) + " LLy: " + str(self.lower_left.y))
        return ("URx: " + str(self.upper_right.x) + " URy: " + str(self.upper_right.y))

    def __repr__(self, level = 0):
        ret = "LLx: " + str(self.lower_left.x) + " LLy: " + str(self.lower_left.y) + "\n" + "\t"*level + "URx: " + str(self.upper_right.x) + " URy: " + str(self.upper_right.y)
        return ret