    ...
    def create_random(self, size_num: int, r_seed: int = None):
        ...
        for i in range(size_num):
            ...
            tmp_point_upper_right = Point(
                randint(tmp_point_lower_left.x, 99), randint(tmp_point_lower_left.y, 99))
    ...
    class Node():
        ...
        def show(self, level=0, ax=None, c=None):
            ...
            ax.add_patch(matplotlib.patches.Rectangle(
                (self.mbr.lower_left.x, self.mbr.lower_left.y), width, height, fill=None, edgecolor=c[level+5]))
            if len(self.children) != 0:
                ...
                for entry in self.entries:
                    ...
                    ax.add_patch(matplotlib.patches.Rectangle(
                        (entry.mbr.lower_left.x, entry.mbr.lower_left.y), entry_width, entry_height, fill=None, edgecolor='blue'))
                if level != 0:
                    return
            plt.show()
            return
